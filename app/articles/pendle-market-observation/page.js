...
export const metadata = {
  ...
  description: "Pendle Market Outlook: You Can’t Cook Without Ingredients",
};
...
export default function PendleMarketObservationPage() {
  const article = {
    ...
    en: { title: "Pendle Market Outlook: You Can’t Cook Without Ingredients", date: "January 2026" },
  };
